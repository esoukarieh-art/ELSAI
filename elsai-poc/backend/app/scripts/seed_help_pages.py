"""Seed les 9 pages du centre d'aide ESLAÏ (kind=help).
...
HELP_PAGES: list[dict] = [
    {
        "slug": "demarrer",
        "title": "Démarrer avec ESLAÏ",
        "seo_title": "Démarrer avec ESLAÏ — assistant social gratuit et anonyme",
        "seo_description": (
            "Comment commencer à utiliser ESLAÏ, l'assistant social IA anonyme : "
            "choisir son profil, poser une question, accéder aux premières fonctions."
        ),
        "description": "Les bases pour bien commencer avec ESLAÏ en 2 minutes.",
        ...
        "reading_minutes": 2,
        "content_mdx": (
            "ESLAÏ est un **assistant social numérique** qui répond à vos questions "
    ...
    },
    {
        ...
        "title": "Comment discuter avec ESLAÏ",
        "seo_title": "Comment discuter avec ESLAÏ — guide du chat",
        "seo_description": (
            "Apprenez à poser vos questions à ESLAÏ, formuler une situation, "
        ...
        "reading_minutes": 3,
        "content_mdx": (
            "Le chat est le cœur d'ESLAÏ. Voici comment en tirer le meilleur.\n\n"
            "## 4 étapes\n\n"
            ...
            "4. **Rebondissez** — ESLAÏ garde le contexte de la conversation.\n\n"
    ...
    },
    {
        ...
        "seo_title": "Parler à ESLAÏ avec la voix — dictée vocale",
        "seo_description": (
            "Activez le micro pour dicter vos questions à ESLAÏ et écoutez les "
        ...
        "reading_minutes": 2,
        "content_mdx": (
            "Vous préférez parler plutôt qu'écrire ? ESLAÏ vous comprend à l'oral.\n\n"
            "## Dicter un message\n\n"
            ...
            "réponse d'ESLAÏ est lue à haute voix automatiquement.\n\n"
            "## Quand c'est utile\n\n"
    ...
    },
    {
        ...
        "seo_description": (
            "Prenez en photo un courrier administratif : ESLAÏ le décrypte en "
            "langage simple et vous indique les actions à faire."
        ),
        "description": "Prendre une photo d'un courrier pour qu'ESLAÏ l'explique en clair.",
        "hero_eyebrow": "Scan",
        ...
        "reading_minutes": 2,
        "content_mdx": (
            "Un courrier administratif incompréhensible ? ESLAÏ le décode pour vous.\n\n"
            "## 4 étapes\n\n"
            ...
            "Elle le photographie, et ESLAÏ lui explique : *« Vous êtes convoqué·e "
    ...
    },
    {
        ...
        "title": "Installer ESLAÏ sur iPhone et Android",
        "seo_title": "Installer ESLAÏ sur iPhone et Android (PWA)",
        "seo_description": (
            "Ajoutez ESLAÏ à votre écran d'accueil comme une vraie application, "
            "en 30 secondes, sans passer par l'App Store ou Google Play."
        ),
        "description": "Ajouter ESLAÏ à l'écran d'accueil comme une vraie application.",
        "hero_eyebrow": "PWA",
        ...
        "reading_minutes": 2,
        "content_mdx": (
            "ESLAÏ est une **PWA** (Progressive Web App) : vous pouvez l'installer "
            ...
            "Une fois installée, l'icône ESLAÏ apparaît sur votre écran comme une "
            "app classique.\n\n"
            "## Mode hors-ligne\n\n"
            "Les pages principales (accueil, chat, scan) se chargent **même sans "
            "connexion**, mais ESLAÏ a besoin d'internet pour répondre à vos "
    ...
    },
    {
        ...
        "seo_title": "Droit à l'oubli — effacer vos conversations ESLAÏ",
        "seo_description": (
            "Un clic pour supprimer définitivement toutes vos conversations et "
            "votre session ESLAÏ. Sans justification, à tout moment, conformément au RGPD."
        ),
        ...
        "content_mdx": (
            ...
            "avoir à vous justifier. ESLAÏ le rend trivial.\n\n"
            "## En un clic\n\n"
    ...
    },
    {
        ...
        "content_mdx": (
            ...
            "## Comment ESLAÏ t'aide\n\n"
            "Si tu parles d'une situation dangereuse dans le chat, ESLAÏ affiche "
            "**automatiquement** un bandeau rouge avec le numéro approprié et un "
            "lien vers la **Maison des Adolescents** la plus proche.\n\n"
            "ESLAÏ n'est **pas** un professionnel de santé mentale : il peut "
    ...
    {
        "slug": "vie-privee",
        "title": "Comment ESLAÏ protège votre anonymat",
        "seo_title": "Vie privée & anonymat — IA sociale conforme RGPD",
        "seo_description": (
            "Comment ESLAÏ fonctionne sans vous identifier : pas d'inscription, "
            "pas de cookies publicitaires, pas de partage. Hébergé en France."
        ),
        "description": "Ce qu'ESLAÏ ne collecte jamais et comment la session anonyme fonctionne.",
        ...
        "reading_minutes": 3,
        "content_mdx": (
            "Votre anonymat est **le** principe fondateur d'ESLAÏ. Pas une option, "
    ...
    },
    {
        ...
        "seo_title": "FAQ ESLAÏ — questions fréquentes sur l'assistant",
        "seo_description": (
                ...
                "questions": [
                    {
                        ...
                        "a": "Non. ESLAÏ est anonyme par défaut. Aucune inscription requise.",
                    },
                    {
                    ...
                    {
                        "q": "ESLAÏ remplace-t-il un assistant social ?",
                    ...
                    },
                    {
                        ...
                        "a": "ESLAÏ est une IA : il peut se tromper. Pour toute démarche importante, vérifiez sur service-public.fr ou auprès d'un professionnel.",
                    },
                    {
                        "q": "Dans quelle langue ESLAÏ fonctionne-t-il ?",
        ...
        "content_mdx": (
            ...
            "**Non.** ESLAÏ est anonyme par défaut. Aucune inscription, aucun email demandé.\n\n"
            "## ESLAÏ est-il gratuit ?\n\n"
            "**Oui**, pour les particuliers. Il existe une offre payante B2B pour "
            "les employeurs qui souhaitent proposer ESLAÏ à leurs équipes.\n\n"
            ...
            "## ESLAÏ remplace-t-il un assistant social ?\n\n"
            "**Non.** ESLAÏ vous aide à comprendre et préparer vos démarches, mais "
            ...
            "ESLAÏ est une IA : il **peut se tromper**. Pour toute démarche "
            ...
            "## Dans quelle langue ESLAÏ fonctionne-t-il ?\n\n"
