      ...
      <Section>
        <div className="text-elsai-ink/85 max-w-3xl space-y-12 leading-relaxed">
          ...
          <section>
            ...
            <p>ESLAÏ fournit au Client un accès, pour un nombre défini de sièges salariés, à :</p>
            <ul className="mt-3 list-disc space-y-1 pl-6">
              <li>
                l'assistant social conversationnel ESLAÏ (chatbot supervisé) 24h/24h, 7j/7&nbsp;;
              </li>
              <li>
                des consultations humaines par des assistantes sociales diplômées, selon quota
                inclus dans l'offre&nbsp;;
              </li>
          ...
          <section>
            ...
            <p>
              Les tarifs sont exprimés en euros hors taxes (HT), par siège salarié et par mois. TVA
              au taux en vigueur (20 % en France) en sus. Tarifs publics au jour de souscription :
            </p>
            <ul className="mt-3 list-disc space-y-1 pl-6">
          ...
          <section>
            <h2 className="text-elsai-pin-dark mb-3 font-serif text-2xl">5. Durée & engagement</h2>
            <p>
              Les offres Essentiel et Premium sont souscrites pour une{" "}
              <strong>durée initiale de douze (12) mois</strong> à compter de l'activation,
              reconduite tacitement par périodes de douze (12) mois. L'offre Sur mesure est
              souscrite pour une durée initiale de vingt-quatre (24) mois, sauf stipulation
              contraire au devis.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              La facturation est émise mensuellement ou annuellement selon la cadence choisie. Modes
              de paiement acceptés : carte bancaire (via Stripe) et prélèvement SEPA B2B. Les
            ...
            <p className="mt-3">
              ...
              points, ainsi qu'une indemnité forfaitaire pour frais de recouvrement de 40 € (art.
              L.441-10 du Code de commerce).
            </p>
          </section>

          <section>
            <h2 className="text-elsai-pin-dark mb-3 font-serif text-2xl">7. Résiliation</h2>
            <p>
            ...
            <p className="mt-3">
              ...
              grave du Prestataire, le solde de la période d'engagement restant dû demeure exigible.
            </p>
            <p className="mt-3">
              <strong>Résiliation pour manquement :</strong> chacune des parties peut résilier le
              contrat en cas de manquement grave de l'autre partie non régularisé dans un délai de
              trente (30) jours suivant mise en demeure restée infructueuse.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              utilisant le service, ni le contenu des échanges, même sur demande. Les codes d'accès
              sont distribués par le Client selon ses propres modalités, sans collecte d'identifiant
              côté ESLAÏ. Le reporting fourni au Client est strictement agrégé et anonymisé (taux
              d'usage global, grandes thématiques). Cette règle est non négociable&nbsp;: elle est
              la condition même de l'efficacité du service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              traitement propre (et non de sous-traitant du Client), dans la mesure où il détermine
              seul les finalités et moyens du traitement (conseil social anonyme). Le Client
              reconnaît et accepte cette qualification.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-6">
              ...
              <li>
                ne pas revendre, sous-licencier ni mettre à disposition le service à des
                tiers&nbsp;;
              </li>
          ...
          <section>
            <h2 className="text-elsai-pin-dark mb-3 font-serif text-2xl">12. Responsabilité</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              conformes au RGPD (art. 28)&nbsp;: <strong>Stripe Payments Europe Ltd.</strong>{" "}
              (Irlande, UE) pour la facturation ; <strong>Sendinblue SAS / Brevo</strong> (France,
              UE) pour l'envoi des emails transactionnels ; hébergeur souverain français pour le
              stockage applicatif. Aucune donnée conversationnelle ne transite par Stripe ou Brevo.
            </p>
          </section>
